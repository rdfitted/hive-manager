...
use commands::{
    ...
    launch_hive, launch_hive_v2, launch_swarm, launch_solo, launch_fusion, get_session, list_sessions, stop_session, close_session, stop_agent, update_session_metadata,
